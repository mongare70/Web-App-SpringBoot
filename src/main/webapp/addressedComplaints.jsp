...
<html>
<head>
<title>List Of Accepted Complaints</title>
<meta charset="utf-8">
...
<div class="container-fluid bg">
		<div class="row">
			...
			String connectionUrl = "jdbc:mysql://localhost:3306/accommodation_complaints_handling_system";
			String userId = "root";
			...
			<h2 align="center"><font><strong>Welcome here are the Accepted Complaints for:</strong></font></h2>
	...
	<div class="container-fluid bg">
		<div class="row">
			...
			<h2 align="center"><font><strong>Welcome here are the Solved Complaints for:</strong></font></h2>
			<table id="complaints" align="center" cellpadding="5" cellspacing="5" border="1">
			<tr>
			
			</tr>
			<tr>
			<td><b>Solved Complaint Id</b></td>
			<td><b>First Name</b></td>
			<td><b>Last Name</b></td>
			<td><b>Registration Number</b></td>
			<td><b>Hostel</b></td>
