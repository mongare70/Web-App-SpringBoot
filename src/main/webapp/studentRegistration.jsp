...
<div class="container-fluid bg">
		<div class="row">
			...
			<div class="col-md-2 col-sm-4 col-xs-12"></div>
				<!-- Form Start -->
            <form class="form-container" method="post" action="/register" name="registration_form" id="registration_form" onsubmit="return validateForm()">
                ...
                <div class="form-group">
                    ...
                    <input type="number" class="form-control" id="roomNumber" name="roomNumber" placeholder="Room Number">
                </div>
                <div class="form-group">
                ...
                <br>
                <button type="button" class="btn btn-danger btn-block" onClick="window.location.href='studentLogin.jsp'">Cancel</button>
            </form>
				<!-- Form End-->
            <script>
                function validateForm()                                    
                    { 
                        ...
                        var uname = document.forms["registration_form"]["uname"];
                        ...
                        var roomNumber = document.forms["registration_form"]["roomNumber"];
